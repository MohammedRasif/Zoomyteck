...
const DashboardLayout = () => {
    ...
    return (
        <div className={`flex h-screen  ${darkMode ? "bg-black text-white" : "bg-gradient-to-r from-[#EAEFFB] via-[#F5F3E6] to-[#EAEFFB] text-black"}`}>
            {/* Sidebar */}
            <div
                className={`h-full fixed border-r-[1px] border-gray-500  ease-in-out ${darkMode ? "bg-black text-white" : " text-black"} ${isSidebarOpen ? "w-[280px]" : "w-16"}`}
            >
                <div className="h-full flex flex-col justify-between">
                    ...
                    {/* Toggle Button */}
                    <button
                        className={`absolute top-4 right-[16px] rounded-full shadow-md p-1 cursor-pointer ${
            ...
            >
                ...
                <div
                    className={`fixed top-0 z-50 w-full border-b border-gray-500 ${
