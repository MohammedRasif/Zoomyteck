    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row items-center justify-center h-screen  bg-white dark:bg-gray-900 transition-colors">
            ...
            <div className="w-full lg:w-1/2 px-4 sm:px-6 md:px-8 lg:px-20">
                ...
                <h1 className="text-2xl sm:text-3xl lg:text-4xl text-center text-[#004290] dark:text-[#66b3ff] font-semibold">Forgot Password</h1>
                ...
                <form onSubmit={handleSubmit} className="mt-6 sm:mt-8">
                    ...
                    <input
                        ...
                        className="w-full h-12 border border-gray-400 dark:border-gray-600 rounded-md text-[#364636] dark:text-gray-200 bg-gray-100 dark:bg-gray-700 px-3 focus:ring-2 focus:ring-[#004290] dark:focus:ring-[#66b3ff]"
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="mt-6 bg-[#004290] dark:bg-[#003366] w-full px-6 sm:px-7 rounded-md h-12 text-base sm:text-lg font-medium text-[#FAF1E6] uppercase cursor-pointer hover:bg-[#001a90] dark:hover:bg-[#002244] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
