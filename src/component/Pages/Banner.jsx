...
const Banner = () => {
  ...
  return (
    <div className={`w-full  ${darkMode ? "bg-black" : "bg-white"} py-10`}>
      <div
        className={`container mx-auto flex flex-col lg:flex-row items-center justify-between py-32 ${
      ...
      >
        ...
        <div className="w-full lg:w-1/2 mb-8 lg:mb-0 lg:pr-10">
          <h1
            className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium leading-tight mb-4 sm:mb-6 bg-gradient-to-r ${
          ...
          <div className="relative w-full max-w-[50vh]">
            <input
              type="text"
              placeholder="Search"
              className={`w-full h-12 sm:h-14 border ${
                darkMode
