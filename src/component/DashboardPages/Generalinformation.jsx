...
const GeneralInformation = () => {
  ...
  const handleOpenProposalPopup = () => setIsProposalPopupOpen(true);
    ...
    <div className="relative bg-white dark:bg-black text-black dark:text-white p-4 font-sans container mx-auto">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="relative bg-white dark:bg-zinc-800 text-black dark:text-white p-6 rounded-lg shadow-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto transition-all duration-1000 opacity-0" style={{ animation: "fadeIn 3s forwards" }}>
      ...
      {isProposalPopupOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-60">
          <div className="absolute inset-0 bg-opacity-50 backdrop-blur-[2px]" onClick={handleCloseProposalPopup}></div>
          <div className="relative bg-white dark:bg-zinc-700 text-black dark:text-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <form onSubmit={handleSubmitProposal}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full p-2 border border-gray-300 rounded-lg text-black dark:text-white bg-white dark:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
