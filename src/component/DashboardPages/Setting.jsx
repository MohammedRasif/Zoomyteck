...
//   const [fullName, setFullName] = useState("Mohammad Rasif");
//   const [email, setEmail] = useState("info@********.com");
...
//     try {
//       // Define the endpoint (update with your backend's base URL if needed)
//       const endpoint = "http://192.168.10.124:1000/api/v1/user/update-profile/"; // Replace with "http://your-api.com/user/update-profile/" if necessary
...
//       // Update imagePreview if backend returns a new image URL
//       if (data.image) {
